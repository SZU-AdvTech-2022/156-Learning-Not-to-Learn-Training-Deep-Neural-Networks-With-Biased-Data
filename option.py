...
parser.add_argument('--data_dir',         default='./data/mnist/',    help='data directory')
...
#训练测试要改的
parser.add_argument('-e', '--exp_name',   default='var_0.05',         help='experiment name')
parser.add_argument('--checkpoint',       default='./var_0.05/checkpoint_step_0099.pth',               help='checkpoint to resume')
...
parser.add_argument('--is_train',         default=False,               help='whether it is training')
parser.add_argument('--color_var',        default=0.05,   type=float, help='variance for color distribution')
